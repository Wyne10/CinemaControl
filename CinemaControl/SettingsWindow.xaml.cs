...
public partial class SettingsWindow
{
    ...
    public SettingsWindow(SettingsService settingsService)
    {
        ...
        QuarterlyTemplatePathTextBox.Text = _settingsService.Settings.QuarterlyReportTemplatePath;
    }
    ...
    private void Save_Click(object sender, RoutedEventArgs e)
    {
        ...
        _settingsService.Settings.QuarterlyReportTemplatePath = QuarterlyTemplatePathTextBox.Text;
    ...
    private void QuarterlyBrowseButton_Click(object sender, RoutedEventArgs e)
    {
        var openFileDialog = new OpenFileDialog
        {
        ...
        if (openFileDialog.ShowDialog() == true)
        {
            QuarterlyTemplatePathTextBox.Text = openFileDialog.FileName;
        }
    }
}